    ...
    <>
      <section className="intro">
        ...
        <p className="description">
          ...
          applications with stunning user experiences. Currently I'm a Software
          Engineer focused on modernizing and securing web & mobile applications 
          at&nbsp;
          <a href="https://www.theatomgroup.com/" className="company">
            The ATOM Group
          </a>
        </p>
      </section>
